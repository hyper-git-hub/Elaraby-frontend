...
(function(window, document, $) {
  ...
  window.Site = $.site.extend({
    run: function(next) {
      ...
      $(".site-dashboard-menubar").on('changing.site.menubar', function() {
      ...
      $(document).on('click', '[data-toggle="collapse"]', function(e) {
        ...
        if ($target.hasClass('navbar-search-overlap')) {
          ...
          e.preventDefault();
        } else if ($target.attr('id') === 'site-dashboard-navbar-collapse') {
          var isOpen = !$trigger.hasClass('collapsed');
          $body.addClass('site-dashboard-navbar-collapsing');

          $body.toggleClass('site-dashboard-navbar-collapse-show', isOpen);

          setTimeout(function() {
            $body.removeClass('site-dashboard-navbar-collapsing');
          }, 350);
      ...
      $(document).on('click', '[data-toggle="gridmenu"]', function() {
        ...
        $body.toggleClass('site-dashboard-gridmenu-active', !active);
...
$('.clickable').on('click', 'td:not(.not-clickable)', function () {
